...
<body>
    <div class="row no-gutters ">
        ...
        <div class="col ">
            ...
            <div
                class="rightside no-gutters d-flex flex-column justify-content-center align-items-center bg-white position-relative ">
                <img src={{ URL('images/TAKATUF_LOGO.png') }}
                    style="width: 200px; position:absolute ;top: 3px; ; left: 25px; " alt="">
                <h1 class="display-1">Organization</h1>
                <a href="{{ route('register') }}" class="ms-4 text-muted"> <button type="button" id="Organizationbtn"
                        class="btn  btn-lg ">Continue</button></a>
            </div>
        ...
        <div class="col">
            ...
            <div class="leftside no-gutters d-flex flex-column  justify-content-center align-items-center">

                <h1 id="hv" class="display-1 ">Volunteer</h1>

                <a href="{{ route('registerVolunteer') }}" class="ms-4 text-muted"> <button type="button"
                        id="Organizationbtn" class="btn  btn-lg  "
                        style="background: white ;color:#008989">Continue</button></a>
